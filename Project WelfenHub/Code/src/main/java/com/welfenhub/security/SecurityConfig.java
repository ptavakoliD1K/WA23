    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests(auth -> auth
                        .antMatchers("/register", "/login", "/css/**", "/images/**", "/static/**", "/templates/**", "/passwordreset", "/upload", "/js/**", "/passwordResetProcess", "/reset-password**", "/setNewPassword**","/posts/**", "/event/get-event", "/event/get-event-count", "/event/show**").permitAll()
